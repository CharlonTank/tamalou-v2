...
applyDoubleAnimationsToOpponent sessionId cardIndex cardToAnimate { discardPilePosition, opponentsDisposition } { leftPlayer, topLeftPlayer, topRightPlayer, rightPlayer } =
    let
