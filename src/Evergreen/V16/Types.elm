...
type alias FPlayer =
    { name : String
    , tableHand : List Evergreen.V16.Card.FCard
...
type alias TamalouOwner =
    { sessionId : Lamdera.SessionId
    , tableHand : List Evergreen.V16.Card.Card
    }


type alias FTableHand =
    List Evergreen.V16.Card.FCard
...
type FPlayerToPlayStatus
    = FWaitingPlayerAction (Maybe Evergreen.V16.Card.Power)
    | FPlayerHasDraw Evergreen.V16.Card.FCard
    | FPlayerHasDiscard Evergreen.V16.Card.Power
...
type BPlayerToPlayStatus
    = BWaitingPlayerAction (Maybe Evergreen.V16.Card.Power)
    | BPlayerHasDraw Evergreen.V16.Card.Card
    | BPlayerHasDiscard Evergreen.V16.Card.Power
...
type BackendMsgFromGame
    ...
    | BeginGameAndDistribute4CardsToEach (List Evergreen.V16.Card.Card)
