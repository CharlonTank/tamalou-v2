...
import Evergreen.V54.Animator.Timeline
import Evergreen.V54.Card
import Evergreen.V54.Game
import Evergreen.V54.Player
import Evergreen.V54.Positioning.Types
import Evergreen.V54.Router
import Evergreen.V54.Utils.Ui
import Lamdera
import Time
import Url
...
type alias PositionedPlayer =
    { player : Evergreen.V54.Player.FPlayer
    , positionedTableHand : List ( Evergreen.V54.Card.FCard, Evergreen.V54.Animator.Timeline.Timeline Evergreen.V54.Positioning.Types.GBPosition )
    , namePosition : Evergreen.V54.Positioning.Types.GBPosition
    }
...
type alias Positions =
    { drawPilePosition : Evergreen.V54.Positioning.Types.GBPosition
    , cardsFromDrawPileMovingPositions : List (Evergreen.V54.Animator.Timeline.Timeline Evergreen.V54.Positioning.Types.GBPosition)
    , drewCardMovingPosition : Evergreen.V54.Animator.Timeline.Timeline Evergreen.V54.Positioning.Types.GBPosition
    , middleTextPosition : Evergreen.V54.Positioning.Types.GBPosition
    , discardPilePosition : Evergreen.V54.Positioning.Types.GBPosition
    , cardFromDiscardPileMovingPositions : Maybe (Evergreen.V54.Animator.Timeline.Timeline Evergreen.V54.Positioning.Types.GBPosition)
    , playAgainOrPassPosition : Evergreen.V54.Positioning.Types.GBPosition
    , opponentsDisposition : OpponentsDisposition
    , ownCardsDisposition : List ( Evergreen.V54.Card.FCard, Evergreen.V54.Animator.Timeline.Timeline Evergreen.V54.Positioning.Types.GBPosition )
    }
...
type alias FrontendModel =
    ...
    , device : Evergreen.V54.Utils.Ui.Device
    , fGame : Maybe Evergreen.V54.Game.FGame
    , roomName : String
    ...
    , posix : Time.Posix
    , route : Evergreen.V54.Router.Route
    }


type alias BackendModel =
    { games : List Evergreen.V54.Game.BGame
    , errors : List String
...
type PlayerActionAnimation
    ...
    | AnimationReplaceCardInTableHand Lamdera.SessionId Int Evergreen.V54.Card.Card
    | AnimationDoubleCardSuccess Lamdera.SessionId Int Evergreen.V54.Card.Card
    | AnimationDoubleCardFailed Lamdera.SessionId Int Evergreen.V54.Card.Card
...
type FrontendMsg
    ...
    | ImReadyFrontend
    | ReStartGameFrontend (Maybe Evergreen.V54.Player.FPlayer)
    | TamalouFrontend
    | PowerIsUsedFrontend
    | PowerPassFrontend
    ...
    | Frame Time.Posix
    | UpdateFGamePostAnimationFrontend Evergreen.V54.Game.FGame PlayerActionAnimation
...
type ActionFromGameToBackend
    ...
    | ImReadyToBackend
    | ReStartGameToBackend (Maybe Evergreen.V54.Player.FPlayer)
...
type ToFrontend
    ...
    | UpdateGameStatusToFrontend Evergreen.V54.Game.FGame (Maybe PlayerActionAnimation)
    | UpdateGameAndChatToFrontend ( Evergreen.V54.Game.FGame, List ( String, String ) )
