...
type alias FPlayer =
    { name : String
    , tableHand : List Evergreen.V22.Card.FCard
...
type alias TamalouOwner =
    { sessionId : Lamdera.SessionId
    , tableHand : List Evergreen.V22.Card.Card
    }


type alias FTableHand =
    List Evergreen.V22.Card.FCard
...
type FPlayerToPlayStatus
    = FWaitingPlayerAction (Maybe Evergreen.V22.Card.Power)
    | FPlayerHasDraw Evergreen.V22.Card.FCard
    | FPlayerHasDiscard Evergreen.V22.Card.Power
...
type BPlayerToPlayStatus
    = BWaitingPlayerAction (Maybe Evergreen.V22.Card.Power)
    | BPlayerHasDraw Evergreen.V22.Card.Card
    | BPlayerHasDiscard Evergreen.V22.Card.Power
