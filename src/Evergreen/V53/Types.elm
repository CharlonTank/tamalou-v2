...
import Evergreen.V53.Animator.Timeline
import Evergreen.V53.Card
import Evergreen.V53.Game
import Evergreen.V53.Player
import Evergreen.V53.Positioning.Types
import Evergreen.V53.Router
import Evergreen.V53.Utils.Ui
import Lamdera
import Time
import Url
...
type alias PositionedPlayer =
    { player : Evergreen.V53.Player.FPlayer
    , positionedTableHand : List ( Evergreen.V53.Card.FCard, Evergreen.V53.Animator.Timeline.Timeline Evergreen.V53.Positioning.Types.GBPosition )
    , namePosition : Evergreen.V53.Positioning.Types.GBPosition
    }
...
type alias Positions =
    { drawPilePosition : Evergreen.V53.Positioning.Types.GBPosition
    , cardsFromDrawPileMovingPositions : List (Evergreen.V53.Animator.Timeline.Timeline Evergreen.V53.Positioning.Types.GBPosition)
    , drewCardMovingPosition : Evergreen.V53.Animator.Timeline.Timeline Evergreen.V53.Positioning.Types.GBPosition
    , middleTextPosition : Evergreen.V53.Positioning.Types.GBPosition
    , discardPilePosition : Evergreen.V53.Positioning.Types.GBPosition
    , cardFromDiscardPileMovingPositions : Maybe (Evergreen.V53.Animator.Timeline.Timeline Evergreen.V53.Positioning.Types.GBPosition)
    , playAgainOrPassPosition : Evergreen.V53.Positioning.Types.GBPosition
    , opponentsDisposition : OpponentsDisposition
    , ownCardsDisposition : List ( Evergreen.V53.Card.FCard, Evergreen.V53.Animator.Timeline.Timeline Evergreen.V53.Positioning.Types.GBPosition )
    }
...
type alias FrontendModel =
    ...
    , device : Evergreen.V53.Utils.Ui.Device
    , fGame : Maybe Evergreen.V53.Game.FGame
    , roomName : String
    ...
    , posix : Time.Posix
    , route : Evergreen.V53.Router.Route
    }


type alias BackendModel =
    { games : List Evergreen.V53.Game.BGame
    , errors : List String
...
type PlayerActionAnimation
    ...
    | AnimationReplaceCardInTableHand Lamdera.SessionId Int Evergreen.V53.Card.Card
    | AnimationDoubleCardSuccess Lamdera.SessionId Int Evergreen.V53.Card.Card
    | AnimationDoubleCardFailed Lamdera.SessionId Int Evergreen.V53.Card.Card
...
type FrontendMsg
    ...
    | ImReadyFrontend
    | ReStartGameFrontend (Maybe Evergreen.V53.Player.FPlayer)
    | TamalouFrontend
    | PowerIsUsedFrontend
    | PowerPassFrontend
    ...
    | Frame Time.Posix
    | UpdateFGamePostAnimationFrontend Evergreen.V53.Game.FGame PlayerActionAnimation
...
type ActionFromGameToBackend
    ...
    | ImReadyToBackend
    | ReStartGameToBackend (Maybe Evergreen.V53.Player.FPlayer)
...
type ToFrontend
    ...
    | UpdateGameStatusToFrontend Evergreen.V53.Game.FGame (Maybe PlayerActionAnimation)
    | UpdateGameAndChatToFrontend ( Evergreen.V53.Game.FGame, List ( String, String ) )
