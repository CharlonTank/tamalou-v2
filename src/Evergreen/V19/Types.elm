...
type alias FPlayer =
    { name : String
    , tableHand : List Evergreen.V19.Card.FCard
...
type alias TamalouOwner =
    { sessionId : Lamdera.SessionId
    , tableHand : List Evergreen.V19.Card.Card
    }


type alias FTableHand =
    List Evergreen.V19.Card.FCard
...
type FPlayerToPlayStatus
    = FWaitingPlayerAction (Maybe Evergreen.V19.Card.Power)
    | FPlayerHasDraw Evergreen.V19.Card.FCard
    | FPlayerHasDiscard Evergreen.V19.Card.Power
...
type BPlayerToPlayStatus
    = BWaitingPlayerAction (Maybe Evergreen.V19.Card.Power)
    | BPlayerHasDraw Evergreen.V19.Card.Card
    | BPlayerHasDiscard Evergreen.V19.Card.Power
