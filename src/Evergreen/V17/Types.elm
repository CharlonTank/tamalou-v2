...
type alias FPlayer =
    { name : String
    , tableHand : List Evergreen.V17.Card.FCard
...
type alias TamalouOwner =
    { sessionId : Lamdera.SessionId
    , tableHand : List Evergreen.V17.Card.Card
    }


type alias FTableHand =
    List Evergreen.V17.Card.FCard
...
type FPlayerToPlayStatus
    = FWaitingPlayerAction (Maybe Evergreen.V17.Card.Power)
    | FPlayerHasDraw Evergreen.V17.Card.FCard
    | FPlayerHasDiscard Evergreen.V17.Card.Power
...
type BPlayerToPlayStatus
    = BWaitingPlayerAction (Maybe Evergreen.V17.Card.Power)
    | BPlayerHasDraw Evergreen.V17.Card.Card
    | BPlayerHasDiscard Evergreen.V17.Card.Power
