...
import Evergreen.V52.Animator.Timeline
import Evergreen.V52.Card
import Evergreen.V52.Game
import Evergreen.V52.Player
import Evergreen.V52.Positioning.Types
import Evergreen.V52.Utils.Ui
import Lamdera
import Time
import Url
...
type alias PositionedPlayer =
    { player : Evergreen.V52.Player.FPlayer
    , positionedTableHand : List ( Evergreen.V52.Card.FCard, Evergreen.V52.Animator.Timeline.Timeline Evergreen.V52.Positioning.Types.GBPosition )
    , namePosition : Evergreen.V52.Positioning.Types.GBPosition
    }
...
type alias Positions =
    { drawPilePosition : Evergreen.V52.Positioning.Types.GBPosition
    , cardsFromDrawPileMovingPositions : List (Evergreen.V52.Animator.Timeline.Timeline Evergreen.V52.Positioning.Types.GBPosition)
    , drewCardMovingPosition : Evergreen.V52.Animator.Timeline.Timeline Evergreen.V52.Positioning.Types.GBPosition
    , middleTextPosition : Evergreen.V52.Positioning.Types.GBPosition
    , discardPilePosition : Evergreen.V52.Positioning.Types.GBPosition
    , cardFromDiscardPileMovingPositions : Maybe (Evergreen.V52.Animator.Timeline.Timeline Evergreen.V52.Positioning.Types.GBPosition)
    , playAgainOrPassPosition : Evergreen.V52.Positioning.Types.GBPosition
    , opponentsDisposition : OpponentsDisposition
    , ownCardsDisposition : List ( Evergreen.V52.Card.FCard, Evergreen.V52.Animator.Timeline.Timeline Evergreen.V52.Positioning.Types.GBPosition )
    }
...
type alias FrontendModel =
    ...
    , device : Evergreen.V52.Utils.Ui.Device
    , fGame : Evergreen.V52.Game.FGame
...
type alias BackendModel =
    { games : List Evergreen.V52.Game.BGame
    , errors : List String
...
type PlayerActionAnimation
    ...
    | AnimationReplaceCardInTableHand Lamdera.SessionId Int Evergreen.V52.Card.Card
    | AnimationDoubleCardSuccess Lamdera.SessionId Int Evergreen.V52.Card.Card
    | AnimationDoubleCardFailed Lamdera.SessionId Int Evergreen.V52.Card.Card
...
type FrontendMsg
    ...
    | ImReadyFrontend
    | ReStartGameFrontend (Maybe Evergreen.V52.Player.FPlayer)
    | TamalouFrontend
    | PowerIsUsedFrontend
    | PowerPassFrontend
    ...
    | Frame Time.Posix
    | UpdateFGamePostAnimationFrontend Evergreen.V52.Game.FGame PlayerActionAnimation
...
type ActionFromGameToBackend
    ...
    | ImReadyToBackend
    | ReStartGameToBackend (Maybe Evergreen.V52.Player.FPlayer)
...
type ToFrontend
    ...
    | UpdateGameStatusToFrontend Evergreen.V52.Game.FGame (Maybe PlayerActionAnimation)
    | UpdateGameAndChatToFrontend ( Evergreen.V52.Game.FGame, List ( String, String ) )
