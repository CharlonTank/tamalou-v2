...
migrate_Types_BackendMsg old =
    case old of
        ...
        Evergreen.V1.Types.GotUserConnected p0 p1 ->
            Evergreen.V2.Types.NoOpBackendMsg

        Evergreen.V1.Types.GotUserDisconnected p0 p1 ->
            Evergreen.V2.Types.GotUserDisconnected p0 p1

        Evergreen.V1.Types.BeginGameAndDistribute4CardsToEach p0 ->
            Evergreen.V2.Types.NoOpBackendMsg


migrate_Types_FGame : Evergreen.V1.Types.FrontendGame -> Evergreen.V2.Types.FGame
migrate_Types_FGame old =
    case old of
        Evergreen.V1.Types.FrontendWaitingForPlayers p0 ->
            Evergreen.V2.Types.FWaitingForPlayers []

        Evergreen.V1.Types.FrontendGameInProgress p0 p1 p2 ->
            Evergreen.V2.Types.FWaitingForPlayers []

        Evergreen.V1.Types.FrontendGameEnded p0 ->
            Evergreen.V2.Types.FWaitingForPlayers []
...
migrate_Types_ToFrontend old =
    case old of
        ...
        Evergreen.V1.Types.ConnectedBack p0 p1 ->
            Evergreen.V2.Types.NoOpToFrontend

        Evergreen.V1.Types.UpdateGame p0 ->
            Evergreen.V2.Types.NoOpToFrontend
