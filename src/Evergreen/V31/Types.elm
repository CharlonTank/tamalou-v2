...
type alias FPlayer =
    { name : String
    , tableHand : List Evergreen.V31.Card.FCard
...
type alias TamalouOwner =
    { sessionId : Lamdera.SessionId
    , tableHand : List Evergreen.V31.Card.Card
    }


type alias FTableHand =
    List Evergreen.V31.Card.FCard
...
type FPlayerToPlayStatus
    = FWaitingPlayerAction (Maybe Evergreen.V31.Card.Power)
    | FPlayerHasDraw Evergreen.V31.Card.FCard
    | FPlayerHasDiscard Evergreen.V31.Card.Power
...
type BPlayerToPlayStatus
    = BWaitingPlayerAction (Maybe Evergreen.V31.Card.Power)
    | BPlayerHasDraw Evergreen.V31.Card.Card
    | BPlayerHasDiscard Evergreen.V31.Card.Power
