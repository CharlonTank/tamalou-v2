...
type alias FPlayer =
    { name : String
    , tableHand : List Evergreen.V36.Card.FCard
...
type alias TamalouOwner =
    { sessionId : Lamdera.SessionId
    , tableHand : List Evergreen.V36.Card.Card
    }


type alias FTableHand =
    List Evergreen.V36.Card.FCard
...
type FPlayerToPlayStatus
    = FWaitingPlayerAction (Maybe Evergreen.V36.Card.Power)
    | FPlayerHasDraw Evergreen.V36.Card.FCard
    | FPlayerHasDiscard Evergreen.V36.Card.Power
...
type BPlayerToPlayStatus
    = BWaitingPlayerAction (Maybe Evergreen.V36.Card.Power)
    | BPlayerHasDrawn Evergreen.V36.Card.Card
    | BPlayerHasDiscard Evergreen.V36.Card.Power
